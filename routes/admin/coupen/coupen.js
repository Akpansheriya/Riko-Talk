...
coupenControllerRouter.delete("/delete-coupen/:id", coupenController.deleteCoupen);
coupenControllerRouter.put("/coupen-status/:id", coupenController.toggleCoupenStatus);
